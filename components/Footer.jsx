                                        ...
                                        <div className="footer__contact">
                                            <ul>
                                                <li className="address">
                                                    ...
                                                    <span className="text">
                                                        <a>Urban Livin, Plot No - 208, 1st Floor, opposite of Post Office, Saheed Nagar, Bhubaneswar, Odisha 751007</a>
                                                    </span>
                                                </li>
                                                <li>
                                                    <span className="icon">
                                                ...
                                                <li>
                                                    ...
                                                    <span className="text">
                                                        <a href="mailto:livinwithurban@gmail.com">livinwithurban@gmail.com</a>
                                                    </span>
                                                </li>
                                                <li>
                                        ...
                                        <div className="footer__contact">
                                            <ul>
                                                <li className="address">
                                                    ...
                                                    <span className="text">
                                                        <a>Urban Livin, River Point Super Market CDA Sec - 10, Cuttack, Odisha 753014</a>
                                                    </span>
                                                </li>
                                                <li>
                                                    <span className="icon">
                                                ...
                                                <li>
                                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4433.4789199832485!2d85.82522589999999!3d20.4834984!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a1911dcd3527f11%3A0x86f2cdbbc5280ac9!2sRIVER%20POINT%20SUPER%20MARKET!5e1!3m2!1sen!2sin!4v1745386541992!5m2!1sen!2sin" width="600" height="90" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div className="footer__contact">
                                            <ul>
                                                <li className="address">
                                                    ...
                                                    <span className="text">
                                                        <a>Ashirwad towers, 2nd Floor Besides SBI Beheramal branch Beheramal chowk , Jharsuguda 768203</a>
                                                    </span>
                                                </li>
                                                <li>
                                                    <span className="icon">
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="footer__copyright text-lg-center text-center">
                                        <p className="mb-0">
                                            Copyright © 2025 Urban Livin | All Rights Reserved. Developed By
                                            <a target="_blank" href="https://thetechnovate.com/">
                                                {" "}
                                                Technovate
                                            </a>
                                        </p>
