                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6" data-aos="fade-up">
                            <div className="choose-us__media m-0">
                                ...
                                <img className="wow clip-a-z" src="/assets/imgs/doors/ld.jpg" alt="image not found" />
                            </div>
                        </div>
                        <div className="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                            <div className="choose-us__content">
                                <div className="section-2__title-wrapper mb-20">
                                    <h2 className="section__title   title-animation">Laminated Door and Panels </h2>
                                    <p className="mb-0">        <img className="wow clip-a-z" src="/assets/imgs/doors/5.png" style={{height:"100px", widows:"100px"}} alt="image not found" /></p>
                                </div>
                                <p>At Artima, our mission is to empower businesses like yours to achieve remarkable growth and lasting success. we achieve this through approach that focuses on your unique needs and goals.</p>
                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                            <div className="choose-us__content">
                                <div className="section-2__title-wrapper mb-20">
                                    <h2 className="section__title   title-animation">Decorative Doors </h2>
                                    <p className="mb-0">        <img className="wow clip-a-z" src="/assets/imgs/doors/2.png" style={{height:"100px", widows:"100px"}} alt="image not found" /></p>
                                </div>
                                <p className="">At Artima, our mission is to empower businesses like yours to achieve remarkable growth and lasting success. we achieve this through approach that focuses on your unique needs and goals.</p>
                        ...
                        <div className="col-lg-6 right-img-padding" data-aos="fade-up">
                            <div className="choose-us__media">
                                ...
                                <img className="wow clip-a-z" src="/assets/imgs/doors/dd.jpg" alt="image not found" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6" data-aos="fade-up">
                            <div className="choose-us__media m-0">
                                ...
                                <img className="wow clip-a-z" src="/assets/imgs/doors/dd2.jpg" alt="image not found" />
                            </div>
                        </div>
                        <div className="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                            <div className="choose-us__content">
                                <div className="section-2__title-wrapper mb-20">
                                    <h2 className="section__title   title-animation">Decorative Doors  </h2>
                                    <p className="mb-0">        <img className="wow clip-a-z" src="/assets/imgs/doors/6.png" style={{height:"100px", widows:"100px"}} alt="image not found" /></p>
                                </div>
                                <p>At Artima, our mission is to empower businesses like yours to achieve remarkable growth and lasting success. we achieve this through approach that focuses on your unique needs and goals.</p>
