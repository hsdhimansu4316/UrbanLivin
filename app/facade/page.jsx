                        ...
                        <div className="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                            <div className="choose-us__content">
                                <div className="section-2__title-wrapper mb-20">
                                    ...
                                    <p className="      ">
                                        {" "}
                                        <img className="wow clip-a-z" src="/assets/imgs/logo/4.png" style={{ height: "100px", widows: "100px" }} alt="image not found" />
                                    </p>
                                </div>
                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6" data-aos="fade-up">
                            <div className="choose-us__media m-0">
                                <div className="choose-us__shape rr-upDown"></div>
                                <img className="wow clip-a-z prd-img" src="/assets/imgs/facade/3.png" alt="image not found" />
                            </div>
                        </div>
                        <div className="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                            <div className="choose-us__content">
                        ...
                        <div className="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                            <div className="choose-us__content">
                                <div className="section-2__title-wrapper mb-20">
                                    ...
                                    <p className="      ">
                                        {" "}
                                        <img className="wow clip-a-z bg-white" src="/assets/imgs/logo/1.png" style={{ height: "100px", widows: "100px" }} alt="image not found" />
                                    </p>
                                </div>
                                <p className="mb-0">At Artima, our mission is to empower businesses like yours to achieve remarkable growth and lasting success. we achieve this through approach that focuses on your unique needs and goals.</p>
