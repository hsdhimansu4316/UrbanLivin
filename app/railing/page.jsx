                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6" data-aos="fade-up">
                            <div className="choose-us__media m-0">
                                ...
                                <img className="wow clip-a-z prd-img" src="/assets/imgs/railing/railing.jpg" alt="image not found" />
                            </div>
                        </div>
                        <div className="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                            <div className="choose-us__content">
                                <div className="section-2__title-wrapper mb-20">
                                    ...
                                    <p className="mb-0">
                                        {" "}
                                               <img className="wow clip-a-z" src="/assets/imgs/logo/15.png" style={{ height: "100px", widows: "100px" }} alt="image not found" />
                                    </p>
                                </div>
